-- Sun* Kudos Live Board — Demo Seed Data
-- Local: applied automatically by `supabase db reset`.
-- Cloud: run manually with `psql "$(npx supabase db remote connection-string)" < supabase/seed.sql`

-- ─────────────────────────────────────────────
-- Auth users — requires pgcrypto (extensions schema on Supabase cloud)
-- ─────────────────────────────────────────────
...
INSERT INTO auth.users (
  ...
  ('00000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000000','authenticated','authenticated','do.hoang.hiep@sunasterisk.com',  extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Đỗ Hoàng Hiệp"}',  false,'','','',''),
  ('00000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000000','authenticated','authenticated','nguyen.van.quy@sunasterisk.com',   extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Nguyễn Văn Quy"}',  false,'','','',''),
  ('00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000000','authenticated','authenticated','duong.thuy.an@sunasterisk.com',    extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Dương Thúy An"}',   false,'','','',''),
  ('00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000000','authenticated','authenticated','mai.phuong.thuy@sunasterisk.com',  extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Mai Phương Thúy"}', false,'','','',''),
  ('00000000-0000-0000-0000-000000000005','00000000-0000-0000-0000-000000000000','authenticated','authenticated','nguyen.ba.chuc@sunasterisk.com',   extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Nguyễn Bá Chức"}', false,'','','',''),
  ('00000000-0000-0000-0000-000000000006','00000000-0000-0000-0000-000000000000','authenticated','authenticated','nguyen.hoang.linh@sunasterisk.com',extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Nguyễn Hoàng Linh"}',false,'','','',''),
  ('00000000-0000-0000-0000-000000000007','00000000-0000-0000-0000-000000000000','authenticated','authenticated','le.kieu.trang@sunasterisk.com',    extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Lê Kiều Trang"}',   false,'','','',''),
  ('00000000-0000-0000-0000-000000000008','00000000-0000-0000-0000-000000000000','authenticated','authenticated','huynh.duong.xuan@sunasterisk.com', extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Huỳnh Dương Xuân"}',false,'','','',''),
  ('00000000-0000-0000-0000-000000000009','00000000-0000-0000-0000-000000000000','authenticated','authenticated','tran.minh.khoa@sunasterisk.com',   extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Trần Minh Khoa"}',  false,'','','',''),
  ('00000000-0000-0000-0000-000000000010','00000000-0000-0000-0000-000000000000','authenticated','authenticated','pham.thi.lan@sunasterisk.com',     extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Phạm Thị Lan"}',   false,'','','',''),
  ('00000000-0000-0000-0000-000000000011','00000000-0000-0000-0000-000000000000','authenticated','authenticated','vo.thi.hoa@sunasterisk.com',       extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Võ Thị Hoa"}',     false,'','','',''),
  ('00000000-0000-0000-0000-000000000012','00000000-0000-0000-0000-000000000000','authenticated','authenticated','bui.van.thanh@sunasterisk.com',    extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Bùi Văn Thành"}',  false,'','','',''),
  ('00000000-0000-0000-0000-000000000013','00000000-0000-0000-0000-000000000000','authenticated','authenticated','nguyen.thi.thu@sunasterisk.com',   extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Nguyễn Thị Thu"}', false,'','','',''),
  ('00000000-0000-0000-0000-000000000014','00000000-0000-0000-0000-000000000000','authenticated','authenticated','hoang.van.duc@sunasterisk.com',    extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Hoàng Văn Đức"}',  false,'','','',''),
  ('00000000-0000-0000-0000-000000000015','00000000-0000-0000-0000-000000000000','authenticated','authenticated','tran.thi.mai@sunasterisk.com',     extensions.crypt('Demo1234!',extensions.gen_salt('bf')),NOW(),NOW(),NOW(),'{"provider":"google","providers":["google"]}','{"full_name":"Trần Thị Mai"}',   false,'','','','')
